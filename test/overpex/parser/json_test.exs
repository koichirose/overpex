defmodule Overpex.Parser.JSONTest do
  ...
  test "parse/1 elements of type 'relation'" do
    json_response = File.read!("test/support/fixtures/parse_json_relations.json")
    assert {:ok, response = %Overpex.Response{}} = JSON.parse(json_response)
  ...
  test "parse/1 elements of type 'way'" do
    json_response = File.read!("test/support/fixtures/parse_json_ways.json")
    assert {:ok, response = %Overpex.Response{}} = JSON.parse(json_response)
  ...
  test "parse/1 empty response" do
    json_response = File.read!("test/support/fixtures/parse_json_empty.json")
    assert {:ok, response = %Overpex.Response{}} = JSON.parse(json_response)
  ...
  test "parse/1 complete response" do
    json_response = File.read!("test/support/fixtures/parse_json_complete.json")
    assert {:ok, response = %Overpex.Response{}} = JSON.parse(json_response)
